...
$(document).ready(function () {
  ...
  $('.google-map').each(function () {
    ...
    bismit.initGoogleMaps(this, lat, lng);
  });
...
$(window).resize(function () {
  ...
  if ($(window).width() > 992 && !burger_menu) {
    ...
    bismit.misc.navbar_menu_visible = 1;
...
$(window).on('scroll', function () {
  ...
  bismit.checkScrollForTransparentNavbar();


  if (window_width > 992) {
    bismit.checkScrollForParallax();
  }

  if (content_opacity == 1) {
    bismit.checkScrollForContentTransitions();
  }
  ...
  initRightMenu: function () {
    ...
    if (!navbar_initialized) {
      ...
      $toggle.click(function () {
        ...
        if (bismit.misc.navbar_menu_visible == 1) {
          $('html').removeClass('nav-open');
          bismit.misc.navbar_menu_visible = 0;
          $('#bodyClick').remove();
          setTimeout(function () {
