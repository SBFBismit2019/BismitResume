        ...
        <div class="row"> 
            <div class="col">
                <div class="form-group mt-5">
                    ...
                    <input type="title" class="form-control" id="inputTitle" name="title" value="{{$gallery->title}}">
                </div>
                <div class="mt-2 align-self-start">
                    <strong><p>Description</p></strong>
                </div>
                <div class="input-group">
                <textarea class="form-control" aria-label="With textarea" rows="5" name="desc">{{$gallery->desc}}</textarea>
                </div>
            </div>
            ...
            <div class="col">
                ...
                <div class="input-group mb-3">
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="inputFile" name="photo" value="{{$gallery->photo}}">
                ...
                <div class="form-group mt-2">
                    ...
                    <input type="link" class="form-control" id="inputLink" name="link" value="{{$gallery->link}}">
                </div>
            </div>
        </div>
